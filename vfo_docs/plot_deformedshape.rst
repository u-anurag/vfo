...
.. function:: vfo.plot_deformedshape(Model="ModelName", LoadCase="LoadCaseName", <tstep = -1>, <scale = 10>, <overlap='no'>)
...
Examples: 
   ...
   ``vfo.plot_deformedshape(Model="TwoSpan_Bridge", LoadCase="Dynamic_GM1", tstep=24.0, scale=50, overlap="yes")``
