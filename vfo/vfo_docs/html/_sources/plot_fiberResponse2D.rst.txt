...
.. function:: vfo.plot_fiberResponse2D(ModelName, LoadCaseName, element, section, LocalAxis = 'y', InputType = 'stress', tstep = -1)
...
Examples: 
   ...
   ``vfo.plot_fiberResponse2D("TwoSpan_Bridge", "Dynamic_GM1", 101, 2)``
